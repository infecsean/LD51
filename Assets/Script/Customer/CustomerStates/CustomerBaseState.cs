...
public abstract class CustomerBaseState
{
    ...
    public abstract void OnCollisionEnter(CustomerStateManager customer, Collider2D collision);

    public abstract void OnButtonPress(CustomerStateManager customer);
}
